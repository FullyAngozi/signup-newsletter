...
function App() {
  ...
  return (
    <div className="md:grid place-items-center md:bg-gray-700  h-screen">
      <div className="flex flex-col gap-7  md:flex-row-reverse bg-white max-w-3xl md:mx-auto md:border md:rounded-xl">
        <div>
          <img
            src={MobileImage}
        ...
        <div className="flex flex-col px-7 max-w-xl gap-4">
          <div>
            <h1 className="font-bold text-3xl text-blue-950 py-3">
              Stay Updated!
            </h1>
